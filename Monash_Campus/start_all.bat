...
set "PROJECT_DIR=C:\Users\bront\OneDrive - Monash University\2026\FYP\code\2026FYP-eBike-in-the-Loop\Monash_Campus"
set "NGROK_DOMAIN=reprogram-manor-fretful.ngrok-free.dev"
